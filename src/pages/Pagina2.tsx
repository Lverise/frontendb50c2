...
export const Pagina2 = () => {
  ...
  return (
    ...
    <Form.Group className="mb-3" controlId="formBasicNombre">
      ...
      <Form.Control type='text' placeholder='Ingrese un número' onChange={(e)=>getN1(e.currentTarget.value)}/>
    </Form.Group>
    <Form.Group className="mb-3" controlId="formBasicApellido">
      <Form.Label>Número 2:</Form.Label>
      <Form.Control type='text' placeholder='Ingrese un número' onChange={(e)=>getN2(e.currentTarget.value)}/>
    </Form.Group>
